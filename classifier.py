...
dataloaders = {} 
dataloaders['train'] = torch.utils.data.DataLoader(train_dataset, batch_size=128, shuffle=True)
dataloaders['val'] = torch.utils.data.DataLoader(test_dataset, batch_size=128, shuffle=True)
...
model_ft = train_model(model_ft.cuda(), criterion, optimizer_ft, exp_lr_scheduler, num_epochs = 5)

#torch.save(model_ft.state_dict(), "classifier.pt")
torch.save(model_ft, "model_unnormalized.pt")
